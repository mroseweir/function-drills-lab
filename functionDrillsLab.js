...
var nameGreeting = nameCheck(`Reese`)
...
function faveColorFinder (color){
  if (color === 'red'){
    ...
    return 'you need to evealuate your favorite color choice'
  }
}
...
console.log(capitalize(sampleString))
console.log('-----')
////////////////// PROBLEM 12 ////////////////////
/*
...
var arrayIsAscending = arrayAscendor(sampleArray)
